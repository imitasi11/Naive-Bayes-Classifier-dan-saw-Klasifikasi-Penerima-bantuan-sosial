...
for($i=1;$i<=$jml_atribut;$i++){
	$query_mysql = "UPDATE nbc_data SET id_parameter ='$tampung[$i]' WHERE id_responden='$id' AND id_atribut='$noatribut[$i]'";
...
$querys_mysql = "UPDATE nbc_responden SET responden ='$nama' WHERE id_responden='$id'";
