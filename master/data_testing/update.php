...
for($i=1;$i<=$jml_atribut;$i++){
	$query_mysql = "UPDATE nbc_data_test SET id_parameter ='$tampung[$i]' WHERE id_responden='$id' AND id_atribut='$noatribut[$i]'";
...
$querys_mysql = "UPDATE nbc_responden_test SET responden ='$nama',alamat ='$alamat' WHERE id_responden='$id'";
