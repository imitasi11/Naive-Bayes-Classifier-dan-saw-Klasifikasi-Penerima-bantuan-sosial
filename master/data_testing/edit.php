 ...
 <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> EDIT Data testing</h3>
  ...
  $ids = $_GET['id'];
  $query_mysql = "SELECT * FROM nbc_responden_test WHERE id_responden='$ids'";
  ...
  ?>
      ...
      Nama
        ...
        <input type="text" class="form-control" name="nama" value="<?php echo $id['responden'] ?>"><br>
        Alamat
          <input type="text" name="alamat" class="form-control" value="<?php echo $id['alamat'] ?>"><br>
       
      <?php
      $querydata_mysql = "SELECT * FROM nbc_data_test WHERE id_responden='$ids' order by id_atribut";
